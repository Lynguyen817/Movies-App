...
#         if user_choice == 4:
#             command_update_movie(movie)
#         if user_choice == 5:
#             command_statistics(movie)
#         if user_choice == 6:
#             command_random_movie(movie)
#         if user_choice == 7:
#             command_search_movie(movie)
#         if user_choice == 8:
#             command_movies_sorted_by_rating(movie)
#         if user_choice == 9:
#             generate_website()
